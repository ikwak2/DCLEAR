...
RcppExport SEXP _DECLEAR_dist_w_ham(SEXP XSEXP, SEXP InfoWSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _DECLEAR_dist_w_ham2(SEXP XSEXP, SEXP InfoWSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const arma::mat >::type X(XSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_DECLEAR_dist_w_ham", (DL_FUNC) &_DECLEAR_dist_w_ham, 2},
    {"_DECLEAR_dist_w_ham2", (DL_FUNC) &_DECLEAR_dist_w_ham2, 2},
    {NULL, NULL, 0}
};

RcppExport void R_init_DECLEAR(DllInfo *dll) {
