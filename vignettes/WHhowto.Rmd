...
The research question is that "Can we reconstruct the lineage of how cells differentiate?". [McKenna et al Science (2016)](https://www.sciencemag.org/doi/10.1126/science.aaf7907) shows the possibility that lineage can be reconstructed through the edited barcode of CRISPR/Cas9 target sites. Scientists can reconstruct the cell lineange based on the information from barcodes of each cell.
